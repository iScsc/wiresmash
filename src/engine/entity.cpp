...
Point* Engine::Entity::getPoint() { return this->point; }
...
void Engine::Entity::addSprite(sf::Drawable* sprite) { this->sprite = sprite; }

sf::Drawable* Engine::Entity::getSprite() { return this->sprite; }
...
PhxBox* Engine::Entity::getPhxBox() { return this->phxbox; }
